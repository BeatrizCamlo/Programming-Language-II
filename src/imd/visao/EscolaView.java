...
public class EscolaView {
	...
	public static void main(String[] args) {
		...
		p1.setNotaParte1(pc.verificarNotaParte1(3.0));
		p1.setNotaParte2(pc.verificarNotaParte2(3.5));
		System.out.println("Nota total p1 => " + p1.calcularNotaTotal());

		Prova p2 = new Prova();
		p2.setNotaParte1(pc.verificarNotaParte1(4.0));
		p2.setNotaParte2(pc.verificarNotaParte2(4.0));
		System.out.println("Nota total p2 => " + p2.calcularNotaTotal());

		Prova p3 = new Prova();
		p3.setNotaParte1(pc.verificarNotaParte1(4.5));
		p3.setNotaParte2(pc.verificarNotaParte2(5.0));
		...
		Prova p5 = new Prova();
		p5.setNotaParte1(pc.verificarNotaParte1(5.0));
		p5.setNotaParte2(pc.verificarNotaParte2(2.5));
		System.out.println("Nota total p5 => " + p5.calcularNotaTotal());

		Prova p6 = new Prova();
		p6.setNotaParte1(pc.verificarNotaParte1(4.5));
		p6.setNotaParte2(pc.verificarNotaParte2(4.5));
		System.out.println("Nota total p6 => " + p6.calcularNotaTotal());

		Prova p7 = new Prova();
		p7.setNotaParte1(pc.verificarNotaParte1(1.5));
		p7.setNotaParte2(pc.verificarNotaParte2(3.0));
		System.out.println("Nota total p7 => " + p7.calcularNotaTotal());

		Prova p8 = new Prova();
		p8.setNotaParte1(pc.verificarNotaParte1(3.5));
		p8.setNotaParte2(pc.verificarNotaParte2(3.0));
